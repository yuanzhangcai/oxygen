...
import (
	...
	"github.com/yuanzhangcai/oxygen/errors"
)
...
func TestVersion(t *testing.T) {
	...
	ctl.Version()
	assert.Equal(t, `{"data":{"build_time":"","build_user":"","commit":"","env":"prod","go_version":"","version":""},"msg":"OK","ret":0}`, w.Body.String())
}
...
func TestOutput(t *testing.T) {
	...
	assert.Equal(t, `{"msg":"系统错误","ret":-999}`, w.Body.String())
}
