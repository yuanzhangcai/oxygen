...
// 自己测试时需要设置环境变量CI_PROJECT_DIR=代码路径，如export CI_PROJECT_DIR=/Users/zacyuan/MyWork/tds/outer/oxygen
...
func TestGetFileNameWithoutSuffix(t *testing.T) {
	assert.Equal(t, "config", GetFileNameWithoutSuffix("/data/tds/outer/oxygen/config.toml"))
}
...
func TestGetEnv(t *testing.T) {
	...
	if CurrRunPath == "" {
		CurrRunPath = "/Users/zacyuan/MyWork/oxygen/"
	}
...
func TestLoadConfig(t *testing.T) {
	...
	assert.Equal(t, "oxygen.zacyuan.com", tmp)
}
